...
function () {
  ...
  function TaskQueue(taskHandler) {
    ...
    this.status = exports.TaskQueueStatus.READY;
    this.tasks = [];
    this.indexes = {};
  }
  /**
  ...
  _createClass(TaskQueue, [{
    ...
    value: function process() {
      ...
      if (this.status === exports.TaskQueueStatus.READY || this.status === exports.TaskQueueStatus.PROCESSING) {
      ...
      } else if (this.status === exports.TaskQueueStatus.PAUSED_READY) {
        this.status = exports.TaskQueueStatus.PAUSED_PENDING;
      }
    }
    /**
    ...
    value: function pause() {
      if (this.status === exports.TaskQueueStatus.PROCESSING) {
        this.status = exports.TaskQueueStatus.PAUSED_PROCESSING;
      } else if (this.status === exports.TaskQueueStatus.READY) {
        this.status = exports.TaskQueueStatus.PAUSED_READY;
      }
    }
    /**
    ...
    value: function resume() {
      if (this.status === exports.TaskQueueStatus.PAUSED_PENDING) {
        this.status = exports.TaskQueueStatus.PROCESSING;
        this.process();
